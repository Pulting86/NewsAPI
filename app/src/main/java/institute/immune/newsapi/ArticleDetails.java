...
public class ArticleDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_urlcompleta.setText("All information: " + intent.getStringExtra("Url"));
        ...
        btn_volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(getBaseContext(), NewAdapter.class);
        ...
        btn_guardar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (guardadasService.getGuardada(id) == null) {

                    Articles articles = articleLab.getArticle(id);
                    Guardadas guardadas=new Guardadas(articles.getAuthor(),articles.getTitle(),articles.getDescription(),articles.getUrl(),articles.getUrlToImage(),articles.getPublishedAt(),articles.getContent(),articles.getId());
                    guardadasService.addGuardadas(guardadas);
                    Toast.makeText(getBaseContext(), "Articulo guardado correctamente", Toast.LENGTH_SHORT).show();
